...
export function HeroSection() {
  ...
  return (
    ...
    >
      <div className="container px-4 md:px-6 flex flex-col md:flex-row items-center gap-8 pt-32 sm:pt-24 md:pt-16 pb-16 sm:pb-0">
        <motion.div
        ...
        >
          ...
          <motion.h2
            className="text-2xl sm:text-3xl md:text-4xl leading-relaxed text-zinc-700 dark:text-zinc-300"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.5, duration: 0.5 }}
          >
            I specialize in designing and developing <span className="text-blue-500">robust Java-based</span>{" "}
            <span className="text-blue-500">applications</span> that help businesses achieve their goals. With a strong
            focus on <span className="text-teal-500">clean code, scalability</span> and{" "}
